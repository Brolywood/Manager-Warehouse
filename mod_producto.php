		...
		<div class="contenedor">
	        ...
	        <div class="formulario">
				...
				if(isset($_POST['actualiza'])){
					...
					$stock=$_POST['stock'];
					$consulta= "UPDATE productos SET stock = (stock + $stock) WHERE cod_producto = '$seleccionar'";
					$ejecutar = mysqli_query($conexion,$consulta);
				...
				if(isset($_POST['modificar'])){
					...
					$consulta= "UPDATE productos SET descripcion = '$descripcion', proveedor = '$proveedor', fecha_ingreso = '$fecha' 
					WHERE cod_producto = '$seleccionar'";
					$ejecutar = mysqli_query($conexion,$consulta);
					header("Location:mod_producto.php");
				};
				?>
